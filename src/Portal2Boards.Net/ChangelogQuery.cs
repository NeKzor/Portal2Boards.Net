...
namespace Portal2Boards
{
    public class ChangelogQuery
    {
        ...
        public ChangelogQuery()
        {
        }
        public ChangelogQuery(ChangelogQuery query)
        {
            MapId = query.MapId;
            ...
            Type = query.Type;
            SinglePlayer = query.SinglePlayer;
            Cooperative = query.Cooperative;
            WorldRecord = query.WorldRecord;
            Banned = query.Banned;
            Demo = query.Demo;
            YouTube = query.YouTube;
            Submission = query.Submission;
            MaxDaysAgo = query.MaxDaysAgo;
